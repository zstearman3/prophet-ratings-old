class PredictionsController < ApplicationController
  ...
  def statistics
    ...
    @month_point_spread_wins = point_spread_wins.where("day > ?", Date.today - 33.days).count
    @month_point_spread_losses = point_spread_losses.where("day > ?", Date.today - 33.days).count
    @month_over_under_wins = over_under_wins.where("day > ?", Date.today - 33.days).count
    @month_over_under_losses = over_under_losses.where("day > ?", Date.today - 33.days).count
    @month_moneyline_wins = moneyline_wins.where("day > ?", Date.today - 33.days).count
    @month_moneyline_losses = moneyline_losses.where("day > ?", Date.today - 33.days).count
    @month_straight_up_wins = straight_up_wins.where("day > ?", Date.today - 33.days).count
    @month_straight_up_losses = straight_up_losses.where("day > ?", Date.today - 33.days).count
    @month_favorite_wins = favorite_wins.where("day > ?", Date.today - 33.days).count
    @month_favorite_losses = favorite_losses.where("day > ?", Date.today - 33.days).count
    @month_underdog_wins = underdog_wins.where("day > ?", Date.today - 33.days).count
    @month_underdog_losses = underdog_losses.where("day > ?", Date.today - 33.days).count
    @month_fast_pace_wins = fast_pace_wins.where("day > ?", Date.today - 33.days).count
    @month_fast_pace_losses = fast_pace_losses.where("day > ?", Date.today - 33.days).count
    @month_slow_pace_wins = slow_pace_wins.where("day > ?", Date.today - 33.days).count
    @month_slow_pace_losses = slow_pace_losses.where("day > ?", Date.today - 33.days).count
    @month_over_wins = over_wins.where("day > ?", Date.today - 33.days).count
